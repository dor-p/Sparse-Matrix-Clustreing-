...
/*adding a set who's element are in values
 * to S
 */
...
/*deletes one set from P and writes its values to target*/
...
/*free all resources allocated to S*/
...
/*allocate a new empty set of sets*/
